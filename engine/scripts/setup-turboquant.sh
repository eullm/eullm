...
echo "Fork verified: GGML_TYPE_Q1_0=41 GGML_TYPE_TBQ3_0=42 GGML_TYPE_TBQ4_0=43 ... GGML_TYPE_TBQP4_4=61 (v1.5.3: Q1_0 inserted at 41, TBQ shifted +1, added _3 double-WHT D=64, _4 head_dim=576)"
echo ""
echo "Build with:"
echo "  cd ${ENGINE_DIR}"
