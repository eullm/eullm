...
| `leonardo/continued_pt_qwen3_30b_a3b_leonardo.yaml` | Phase 1 | same, DeepSpeed ZeRO-3 | Leonardo node (4x A100 64 GB) | < 1 day |
| `leonardo/distill_qwen3_30b_a3b_to_4b_leonardo.yaml` | Phase 2 | same, teacher sharded on 4 GPUs | Leonardo node (4x A100 64 GB) | 5-7 days |
