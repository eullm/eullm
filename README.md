...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Engine-v0.6.14-2ea44f" alt="Engine status" />
...
### Run MoE models on a small GPU (`--cpu-moe` / `--n-cpu-moe`, new in v0.6.11 / v0.6.14)
...
#### Finer control: `--n-cpu-moe N` (new in v0.6.14)
